...
def main():
    ...
    .main {{
        ...
        "https://avatars.dzeninfra.ru/get-zen_doc/1718877/pub_61cacc9bd1e72b6a321017e8_62335a98f781ab27c5f97f55/scale_1200"
        );
...
def home_page():
    ...
    st.markdown("<p class='subtitle'>You have an ability to upload your photo <br> \
                and find out the name of the tourist attraction<br> using a neural network</p>", unsafe_allow_html=True)
